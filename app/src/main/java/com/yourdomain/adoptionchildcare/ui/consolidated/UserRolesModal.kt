...
class UserRolesModal : DialogFragment() {
    override fun onCreateView(
        ...
        val view = inflater.inflate(com.yourdomain.adoptionchildcare.R.layout.dialog_user_roles, container, false)
        val listView: ListView = view.findViewById(com.yourdomain.adoptionchildcare.R.id.user_roles_list)
        val roles = listOf(
            "Admin",
            "Case Worker",
            "Supervisor",
